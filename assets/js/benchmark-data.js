...
window.RMC_BENCHMARK = {
  ...
  sources: {
    ...
    statsRetail2025: {
      name: "2025 年 12 月份社会消费品零售总额增长 0.9%",
      org: "国家统计局",
      pub: "2026-01-19",
      url: "https://www.stats.gov.cn/zwfwck/sjfb/202601/t20260119_1962323.html",
      caliber: "全国（社会消费品零售总额分项 · 全量）"
    },
    filmBureau2025: {
      name: "2025 年中国电影成绩单（全年票房与观影人次）",
      org: "国家电影局（新华社转发）",
      pub: "2026-01-01",
      url: "https://www.news.cn/20260101/46cb9ebaeb8643d0b96fcfb2cb3ef44c/c.html",
      caliber: "全国电影市场（全量）"
    },
    capa2026: {
      name: "2025 年全国演出市场简报",
      org: "中国演出行业协会（新华社转发）",
      pub: "2026-01-13",
      url: "https://www.news.cn/fortune/20260113/d486e37a7f054fe9854d62e427a42991/c.html",
      caliber: "全国营业性演出（不含娱乐场所演出）"
    }
  },
  ...
  /* ---------------- 四个行业：官方总量口径（保守接入）----------------
   * 原则：只发布官方权威的「总量 / 收入 / 人次」口径。
   *      单位产出指标（RevPASH、翻台率、单座收入、上座率）因公开渠道无权威分母，一律不发布。
   *      标 derived 的为官方数据相除得到的推算值，note 中已写明算式。
   * ---------------------------------------------------------------- */
  fnb: {
    official: {
      period: "2025 全年",
      caliber: "全国餐饮收入（国家统计局 · 社会消费品零售总额分项）",
      note: "目前只有「收入」口径：国家统计局不公布营业面积、翻台次数、客单结构等计算 RevPASH 所需的分母，"
        + "因此全国 RevPASH / 翻台率无法从公开渠道推导，任何流传的数字都是估算值，我们不发布。",
      items: [
        { k: "全国餐饮收入",         v: "57,982 亿元",  yoy: "+3.2%",  src: "statsRetail2025", tier: "official" },
        { k: "占社零总额比重",       v: "11.6%",        yoy: "+0.2pp", src: "statsRetail2025", tier: "official" },
        { k: "限额以上单位餐饮收入", v: "16,337 亿元",  yoy: "+2.0%",  src: "statsRetail2025", tier: "official" },
        { k: "12 月 全国餐饮收入",   v: "5,738 亿元",   yoy: "+2.2%",  src: "statsRetail2025", tier: "official" },
        { k: "12 月 限额以上餐饮收入", v: "1,463 亿元", yoy: "-1.1%",  src: "statsRetail2025", tier: "official",
          note: "12 月限上餐饮同比转负，与全年 +2.0% 背离，反映平台补贴下的竞争加剧" }
      ]
    }
  },
  ...
  attraction: {
    official: {
      period: "2025 全年",
      caliber: "全国 A 级旅游景区（文化和旅游部）",
      note: "文旅部只公布 A 级景区的「人次」与「总收入」，不公布分时客流、承载量与二次消费结构，"
        + "所以分时承载率与二次消费占比无法从公开数据得到。",
      items: [
        { k: "A 级景区接待游客", v: "75.1 亿人次",   yoy: "—",       src: "mct2025", tier: "official" },
        { k: "A 级景区旅游收入", v: "5,544.9 亿元",  yoy: "—",       src: "mct2025", tier: "official" },
        { k: "国内出游人次",     v: "65.22 亿人次",  yoy: "+16.2%",  src: "mct2025", tier: "official" },
        { k: "国内出游花费",     v: "6.30 万亿元",   yoy: "+9.5%",   src: "mct2025", tier: "official" },
        { k: "A 级景区人均花费", v: "73.8 元/人次",  yoy: "—",       src: "mct2025", tier: "derived",
          note: "由 5,544.9 亿元 ÷ 75.1 亿人次推算，含门票与景区内消费，非官方直接公布" }
      ]
    }
  },
  ...
  entertainment: {
    official: {
      period: "2025 全年",
      caliber: "全国电影市场（国家电影局）· 娱乐休闲业中唯一有全量权威统计的品类",
      note: "电影有全量权威统计，但放映厅座位数与实际上座率未公布，故单座产出与上座率无法计算；"
        + "单银幕年产可作为影院侧供给效率的替代参考。其余娱乐业态（KTV、密室、剧本杀等）无统一统计口径。",
      items: [
        { k: "全年电影票房",     v: "518.32 亿元",  yoy: "+21.95%", src: "filmBureau2025", tier: "official" },
        { k: "城市院线观影人次", v: "12.38 亿人次", yoy: "+22.57%", src: "filmBureau2025", tier: "official" },
        { k: "国产影片票房",     v: "412.93 亿元",  yoy: "—",       src: "filmBureau2025", tier: "official" },
        { k: "国产片票房占比",   v: "79.67%",       yoy: "—",       src: "filmBureau2025", tier: "official" },
        { k: "银幕总数",         v: "93,187 块",    yoy: "+2,219 块", src: "filmBureau2025", tier: "official" },
        { k: "平均票价",         v: "41.9 元",      yoy: "—",       src: "filmBureau2025", tier: "derived",
          note: "由 518.32 亿元 ÷ 12.38 亿人次推算" },
        { k: "单银幕年产",       v: "55.6 万元/块", yoy: "—",       src: "filmBureau2025", tier: "derived",
          note: "由 518.32 亿元 ÷ 93,187 块推算，可作影院侧供给效率的替代指标" }
      ]
    }
  },
  ...
  theater: {
    official: {
      period: "2025 全年",
      caliber: "全国营业性演出（中国演出行业协会票务信息采集平台，不含娱乐场所演出）",
      note: "协会公布场次、票房与观众人次，但不公布座位总数与实际上座数，因此上座率与单座收入无法计算；"
        + "场均票房与人均票价可替代使用。数据为协会监测与调研测算值。",
      items: [
        { k: "演出场次",               v: "64.04 万场",   yoy: "+6.58%", src: "capa2026", tier: "official" },
        { k: "票房收入",               v: "616.55 亿元",  yoy: "+6.39%", src: "capa2026", tier: "official" },
        { k: "观众人数",               v: "1.94 亿人次",  yoy: "+4.22%", src: "capa2026", tier: "official" },
        { k: "市场总体收入",           v: "837.22 亿元",  yoy: "+5.19%", src: "capa2026", tier: "official",
          note: "含票房外的其他收入 220.67 亿元（同比 +1.98%）" },
        { k: "5000 人以上大型演出票房", v: "324.48 亿元",  yoy: "+9.49%", src: "capa2026", tier: "official",
          note: "观众 4,338.58 万人次（+18.81%）；对其他消费平均带动系数 1:6.85" },
        { k: "剧场类演出场次",         v: "43.87 万场",   yoy: "+7.30%", src: "capa2026", tier: "official" },
        { k: "旅游演艺票房",           v: "174.42 亿元",  yoy: "—",       src: "capa2026", tier: "official" },
        { k: "场均票房",               v: "9.63 万元/场", yoy: "—",       src: "capa2026", tier: "derived",
          note: "由 616.55 亿元 ÷ 64.04 万场推算" },
        { k: "人均票价",               v: "317.8 元",     yoy: "—",       src: "capa2026", tier: "derived",
          note: "由 616.55 亿元 ÷ 1.94 亿人次推算" }
      ]
    }
  },
  ...
  /* ---------------- 仍需社区样本池补齐的单位产出指标 ---------------- */
  pending: [
    { ind: "餐饮业",  metric: "RevPASH / 翻台率 / 客单价", status: "需样本池",
      why: "统计局只公布收入，无营业面积与翻台次数，算不出可信的 RevPASH" },
    { ind: "景区文旅", metric: "分时承载率 / 二次消费占比", status: "需样本池",
      why: "A 级景区仅公布人次与总收入，缺分时客流与消费结构" },
    { ind: "娱乐休闲", metric: "场次上座率 / 单座产出", status: "需样本池",
      why: "电影口径有银幕数与场次，但放映厅座位数与实际上座未公布" },
    { ind: "剧院",     metric: "上座率 / 单座收入", status: "需样本池",
      why: "协会公布场次与票房，未公布座位总数与实际上座" }
  ]
};
